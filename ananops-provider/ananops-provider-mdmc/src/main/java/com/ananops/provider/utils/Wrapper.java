...
/**
 * Created by rongshuai on 2019/11/27 12:10
 */
@Data
...
public class Wrapper<T> implements Serializable {
     ...
     * 序列化标识
     */
    private static final long serialVersionUID = -9071380969548141648L;
     ...
     */
    Wrapper(int code, String message, T result) {//返回一个经过序列化，具有返回码、返回消息、结果数据的Wrapper对象
        super();
